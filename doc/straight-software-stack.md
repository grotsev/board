...
# Если обнаружится конфликт версий зависимостей, который проявляется в виде неожиданной ошибки при компиляции, то нужно полностью удалить '''board/elm/elm-stuff/''' и переустановить все зависимости '''$ elm-package install -y'''.
